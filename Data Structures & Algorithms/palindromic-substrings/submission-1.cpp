...
public:
    ...
    int getCountExpandFromMid(const std::string &in_str, int left, int right){
    ...
    int countSubstrings(const std::string &in_str){	
        ...
        for(int i=0; i < length; i++){
            ...
            int len1= getCountExpandFromMid(in_str,i,i);		
            // search even pallindrom starting from i,i+1
            int len2= getCountExpandFromMid(in_str,i,i+1);
